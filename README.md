...
Firstly, the necessary data to be able to carry out tests with TROVA can be downloaded at the link: [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.6490364.svg)](https://zenodo.org/doi/10.5281/zenodo.6490364) and  [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.6490365.svg)]( [![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.6490364.svg)](https://doi.org/10.5281/zenodo.6490365)). Once you have downloaded the input data corresponding to FLEXPART forced with ERA-Interim, you can use the configuration files and masks available at https://github.com/tramo-ephyslab/TROVA/tree/main/Inputs and https:// github.com/tramo-ephyslab/TROVA/tree/main/Masks respectively. These data are for tests on a certain day and using the methodology of Stohl and James (2005). The results for three days (review the configuration files that correspond to a specific day), either to determine sources or sinks of humidity and analysis of sources by vertical layers are available at https://github.com/tramo-ephyslab /TROVA/tree/main/output . Check that once TROVA is installed you can reproduce these results.
...
**1- TROVA is used in backward in time to determine moisture sources.**
 ...
 <img src="https://github.com/tramo-ephyslab/TROVA/blob/main/Figures/Fig1-git.jpg" align="center" height="200" width="200">
